...
2. In your CloudXray user account, create a new K8s token by heading to "Admin -> Integrations -> K8s Integrations" menu and clicking "New Integration" button. Specify a meaningful token name and click "Create" button. Please create new K8s token for each K8s cluster that you want to connect to CloudXray.
